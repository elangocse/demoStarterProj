...
public class HelloController {
    ...
    public String index() {
        return "Congratulations!! DXC Cloud Native Starter Project is generated successfully!!Click on https://github.com/elangocse/demoStarterProj.git to download your source code and enhance it. ";
    }
